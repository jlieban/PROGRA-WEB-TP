...
export default function TarjetaProducto({ producto, cantidadEnCarrito, onVerDetalle, onAgregar, onActualizarCantidad }) {
            ...
            <div className="producto-info">
                ...
                <div className="tarjeta-botones">
                    {cantidadEnCarrito > 0 ? (
                        ...
                        <button className="btn-agregar" onClick={e => { e.stopPropagation(); onAgregar(producto.id) }}>
                            Agregar al carrito
                        </button>
                    )}
                    <button className="btn-detalle" onClick={e => { e.stopPropagation(); onVerDetalle(producto) }}>
                        Ver detalle
                    </button>
                </div>
            </div>
